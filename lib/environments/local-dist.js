...
exports.config = {
  ...
  azureacs: {
    ...
    realm: 'http://realm.azurewebsites.net/',
    homeRealm: '', // specify an identity provider to avoid showing the idp selector
    identityProviderUrl: 'https://[account].accesscontrol.windows.net/v2/wsfederation',
    thumbprint: '5AB9C9554A7497F69017F831C91B1B3ECE694EFE',
    signoutReply: 'http://localhost/' // url to return to after signout, this needs to be set to whatever azure acs has set for the domain of the Return Url
  },
